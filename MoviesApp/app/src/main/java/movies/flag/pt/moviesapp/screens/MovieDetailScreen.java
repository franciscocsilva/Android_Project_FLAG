...
/**
 * Created by Formando on 20/01/2018.
 */
...
public class MovieDetailScreen extends Screen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeBtn = findViewById(R.id.movie_detail_screen_home_btn);
        backBtn = findViewById(R.id.movie_detail_screen_back_btn);
        title = findViewById(R.id.movie_detail_screen_title);
        rate = findViewById(R.id.movie_detail_screen_rating);
        vote = findViewById(R.id.movie_detail_screen_vote);
        overview = findViewById(R.id.movie_detail_screen_overview);
        moviePoster = findViewById(R.id.movie_detail_screen_poster);
        share = findViewById(R.id.movie_share_btn);
        date = findViewById(R.id.movie_detail_screen_date);
        language = findViewById(R.id.movie_detail_screen_language);
        bomiRvw = findViewById(R.id.movie_detail_screen_bomi_review);


        Intent intent = getIntent();

        Movie item = intent.getParcelableExtra(MOVIE_ITEM_KEY);
        ...
        final String shareSendText = getString(R.string.share_m_1)+ item.getTitle() + getString(R.string.share_m_2) + item.getVoteAverage() + getString(R.string.share_m_3);
